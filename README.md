...
```
{
  ...
  "skillsets": {
    "state_management": "React Redux & Context API", 
    "css_frameworks": ["Tailwind CSS", "Chakra UI", "Material UI", "Bootstrap", "MDBootstrap"],  
    "testing": "TypeScript with TDD Approach (Jest, Cypress, Storybook)",
    "object_manipulation": "Been loving programming since my early days of high school" 
  } 
}
```
